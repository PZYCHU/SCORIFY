...
class DetailKelasScreen extends StatelessWidget {
  ...
  Widget _buildHeader(
      BuildContext context, Kelas kelas, AppProvider provider) {
    return Container(
          ...
          Row(
            children: [
              ...
              PopupMenuButton<String>(
                ...
                onSelected: (val) async {
                  if (val == 'edit') {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('Fitur edit kelas sedang dalam pengembangan')),
                    );
                  } else if (val == 'hapus') {
                ...
                itemBuilder: (_) => [
                  const PopupMenuItem(
                      value: 'edit', child: Text('Edit Kelas')),
                  const PopupMenuItem(
                    value: 'hapus',
                    child:
                        Text('Hapus Kelas', style: TextStyle(color: AppColors.danger)),
                  ),
                ],
              ),
            ],
  ...
  Future<void> _jalankanKalkulasi(
      BuildContext context, AppProvider provider, Kelas kelas) async {
    showDialog(
      context: context,
...
class _MuridCard extends StatelessWidget {
  ...
  const _MuridCard(
      {required this.murid, required this.kelas, this.rank});
